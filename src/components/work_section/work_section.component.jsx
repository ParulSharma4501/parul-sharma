...
function WorkSection() {
    return (
        <div className="work_section">
            ...
            <PRow numImg="/images/2cute.png" center btn="Soon" link="" projectImg="/images/project2.png" projectName="HOME SERVICES APP - SHELTER CHECK" projectDescription="The main aim was to build a website that is basically an online marketplace for local services such as repair & maintenance, home cleaning, homecare & design, pest control, packers & movers, business services, event management, weddings & party management, health & wellness, salon, etc. 
"/>
